    ...
    implements ExtendedDigest, Memoable
{
     ...
     */
    public GOST34311Digest(byte[] sBoxParam)
    {
     ...
     * message digest.
     */
    public GOST34311Digest(GOST34311Digest t)
    {
        reset(t);
    }
   ...
   public int getByteLength() 
   {
    ...
    {
        return new GOST34311Digest(this);
    }

    public void reset(Memoable other)
    {
        GOST34311Digest t = (GOST34311Digest)other;
