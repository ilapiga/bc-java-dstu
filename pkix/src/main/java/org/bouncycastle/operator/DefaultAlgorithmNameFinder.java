    ...
    implements AlgorithmNameFinder
{
    ...
    static
    {
     // 	algorithms.put(UAObjectIdentifiers.dstu4145be, "GOST3411WITHDSTU4145");
      	algorithms.put(UAObjectIdentifiers.dstu4145be, "DSTU4145BE");
	    //algorithms.put(UAObjectIdentifiers.dstu4145le, "GOST3411WITHDSTU4145");
  	    algorithms.put(UAObjectIdentifiers.dstu4145le, "DSTU4145");
  	    algorithms.put(UAObjectIdentifiers.dstu4145WithGost34311le, "GOST34311WITHDSTU4145");
